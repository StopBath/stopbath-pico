 ...
 * would still pass.
 *
 * Copied from the stopbath-flipper repository, tests/test_remote_qr_vectors.c
 * and tests/qr_published_vectors.h at commit
 * 3677e61904d854504ac58c5dce6d6e6419836cfc (header sha256
 * 03f521fdaf9bd695611f36741c9c38eece73449d225cac01f55441be7f903f30), MIT,
 * unchanged below this comment: the same encoder, the same wrapper entry
 * points, the same independent reference. The 29 module ceiling the last
