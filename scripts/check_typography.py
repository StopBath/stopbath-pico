#!/usr/bin/env python3
"""
Repository scan for specification 0.8 (Flipper 0.8, applied here by Pico spec
Part 0): no em dash in any tracked text file,
...
Copied from the stopbath-flipper repository, scripts/check_typography.py at
commit 3677e61904d854504ac58c5dce6d6e6419836cfc (sha256
992c65fb2286c3c690fd7a5a2a01fa85171b57faf06860c7b3c39ceab88b717f), MIT. Two
changes for this repository: the excluded directory set names this project's
build and toolchain directories, and the text file set gains .cmake and
CMakeLists.txt, which the Flipper's build system did not use.
"""
...
EXCLUDED_DIRECTORY_NAMES = {".git", ".toolchain", "build", "dist", "__pycache__", ".idea", ".vscode"}
