...
| total draw beside the appliance's radio adapter | evaluation log 4.5, extension 5.3 | unmeasured; the appliance's gate (its `PE2` row), owed by the appliance for either remote, with an inline USB meter as the method |
